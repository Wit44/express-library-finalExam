...
--
-- Host: 46.240.129.106    Database: sase_2021230123
-- ------------------------------------------------------
...
CREATE TABLE `order` (
  ...
  CONSTRAINT `fk_order_book` FOREIGN KEY (`book_id`) REFERENCES `book` (`book_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
-- Dump completed on 2025-04-15 15:17:16
